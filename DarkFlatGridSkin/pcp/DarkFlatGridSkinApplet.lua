...
applets.DarkFlatGridSkin.DarkFlatGridSkinApplet

=head1 DESCRIPTION

800x480 resolution grid skin (based on PiGridSkin & JogglerSkin)

Built upon the work of 3guk, Tarkan Akdam, Justblair, Andy Davison & Michael Herger.
...
function free(self)
	...
	if desktop then
		...
		package.loaded["applets.DarkFlatSkin.DarkFlatSkinApplet"] = nil
		DarkFlatSkin = require("applets.DarkFlatSkin.DarkFlatSkinApplet")
	end
