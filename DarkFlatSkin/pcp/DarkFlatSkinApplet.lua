...
Built upon the work of 3guk, Tarkan Akdam, Justblair & Andy Davison.

Latest modifications by AF
...
function skin(self, s, reload, useDefaultSize, w, h, useRatingButtonsGridSkin, hideRepeatButtonGridSkin, hideShuffleButtonGridSkin)
	local settings = self:getSettings()
