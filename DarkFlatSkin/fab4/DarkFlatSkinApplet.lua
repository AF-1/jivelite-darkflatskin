...
--------- ICONBAR ---------
	...
	s.nowplaying = _uses(s.window, {
		...
		nptitle = {
			...
			nptrack =  {
				w          = screenWidth - _tracklayout.x - 6,
				h          = WH_FILL,
		...
		npratinggroup = {
			...
			border     = _tracklayout.border,
			x          = _tracklayout.x,
			y          = TITLE_HEIGHT + 23 + 32 + 32 + 35 + 5 - 2,
			h          = 28,
			w			= 162,
		...
		npstatusicongroup = {
			...
			position	= LAYOUT_NONE,
			border		= {0,0,0,0},
			x			= screenWidth - 112, -- 12 (padding right) + (23 + 5) * 2 + (29 + 5) + 34
			y           = TITLE_HEIGHT + 23 + 32 + 32 + 35 + 2 + 9 - 2,
			h			= 18,
...
-----------
	...
	s.nowplaying_text_only = _uses(s.nowplaying, {
		nptitle          = {
                        x = 40,
                        y = TITLE_HEIGHT,
						h = 32 + NP_DIFFERENT_FONT_CORRECT - 10,
                       nptrack =  {
           						align = "center",
                                w = screenWidth - 65,
                        },
		...
		npratinggroup    = {
						x = screenWidth/2 - 81 + 7,
                        y = TITLE_HEIGHT + 34 + 20 + 29 + 31- 11,
                        nprating =  {
                              w = 162,
                        },
		},
		npratingactiongroupunrate1 = {
						...
						y = TITLE_HEIGHT + 23 + 32 + 32 + 35 - 4 - 19,
						w = 40,
		},
		npratingactiongroup1 = {
