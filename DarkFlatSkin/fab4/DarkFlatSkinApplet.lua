...
based on the WQVGAsmallSkin for SB Touch
480x272 resolution
...
function param(self)
		...
		radialClock = {
			hourTickPath     = 'applets/DarkFlatSkin/images/Clocks/Radial/radial_ticks_hr_on.png',
			minuteTickPath   = 'applets/DarkFlatSkin/images/Clocks/Radial/radial_ticks_min_on.png',
		},
...
local function _forceNPscreenToggle(self)
...
function skin(self, s)
	...
	local titlebarButtonBox = _loadTile(self, { nil })
...
--------- ICONBAR ---------
	...
	s.nowplaying = _uses(s.window, {
		...
		npstatusicongroup = {
			...
			y          = TITLE_HEIGHT + 23 + 32 + 32 + 35 + 2 + 10,
			h			= 18,
		...
		npprogress = {
			position = LAYOUT_NONE,
			x = 202,
			y = TITLE_HEIGHT + 29 + 26 + 32 + 32 + 32 + 10,
			padding = { 0, 10, 0, 0 },
...
--			x          = 40,
--			y          = TITLE_HEIGHT + 5,
--			h          = screenHeight - TITLE_HEIGHT - 70 - 6,
--			w          = screenWidth - 30,
--			nplyrics = {
--				w = WH_FILL,
--				h = WH_FILL,
...
--				sh = TEXT_SH_COLOR,
--				scrollbar = {
--					h = screenHeight - TITLE_HEIGHT - 70 - 10,
--					border = {0, 0, 25, 0},
--				},
--			},
--		},
...
--	})
--
--	s.nowplaying_text_lyrics.title.pressed = _uses(s.nowplaying_text_lyrics.title, {
--		text = {
