...
applets.DarkFlatSkinLarge.DarkFlatSkinLargeApplet

=head1 DESCRIPTION

based on the WQVGAlargeSkin for SB Touch
480x272 resolution
...
local log                    = require("jive.utils.log").logger("applet.DarkFlatSkinLarge")
...
--------- DEFAULT WIDGET STYLES ---------
	...
	s.menu_hidden = _uses(s.menu, {	hidden = 1,	})
...
--			},
		...
		npcontrols = {
			...
			rateHigher    = { hidden = 1 },
			rateLower    = { hidden = 1 },
			fwdDisabledNoSkipCount = { hidden = 1 },
			shuffleDisabled = { hidden = 1 },
			repeatDisabled = { hidden = 1 },
