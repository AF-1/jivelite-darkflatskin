...
[^3]: Only available for NowPlaying views with enough screen space:<br>&nbsp;&nbsp;- `piCorPlayer` and `SqueezePlay`: (small) *Artwork and Text* and *Text only*<br>&nbsp;&nbsp;- `SB Touch:` *Text only*
